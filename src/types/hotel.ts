...
export interface Guest {
  ...
  full_name: string;
  phone: string | null;
  phone_number?: string | null; // New field for unique phone tracking
  email: string | null;
  address: string | null;
  is_primary: boolean;
  ...
  id_verified?: boolean; // New field for verified ID status
  first_stay_at?: string | null; // New field for first stay tracking
  last_stay_at?: string | null; // New field for last stay tracking
  created_at: string;
}
