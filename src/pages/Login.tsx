  ...
  const onSignup = async (data: SignupFormData) => {
    ...
    try {
      ...
      toast.success('Account created!', {
        description: 'Please contact admin to get access to the system.',
      });
    } catch (error) {
      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent>
          ...
          <div className="mt-6 rounded-lg bg-muted/50 p-4 text-center text-sm text-muted-foreground">
            <p className="font-medium">Staff Registration</p>
            <p className="mt-1">Sign up and contact admin to get system access</p>
          </div>
        </CardContent>
      </Card>
    </div>
