  ...
  return (
    <div className={cn('rounded-xl border border-border/50 bg-card shadow-luxury', className)}>
      <div className="border-b border-border/50 px-6 py-4">
        <h2 className="font-serif text-xl font-medium text-foreground">Departures Soon</h2>
      </div>
      ...
      <div className="divide-y divide-border/30">
        {departures.length > 0 ? (
          departures.slice(0, 4).map((departure) => (
            <div key={departure.id} className="flex items-center justify-between px-6 py-4">
              <div className="flex items-center gap-4">
                <div className={cn(
                  'flex h-10 w-12 items-center justify-center rounded-md border text-sm font-semibold',
                  departure.isOverdue 
                ...
                <div>
                  <p className="font-medium text-foreground">{departure.guestName}</p>
          ...
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="mt-4 text-sm text-muted-foreground">No pending departures</p>
          </div>
        )}
      </div>
